...
if __name__ == '__main__':
    ...
    with open('/media/mdisk/xkk/Consistency_Regularization_STR/saved_models/TRBA/base/baseline_exp_partial0.1/all_dataset_preds.json') as f:
        pred = json.load(f)
