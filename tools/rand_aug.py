...
def spatial_augment_pool():
    augs = [(ShearX, 0.2, 0.1), (ShearY, 0.2, 0.1), (TranslateX, 0.2, 0.1),
            (TranslateY, 0.2, 0.1), (Rotate, 10, 10)]
    return augs


def channel_augment_pool():
    augs = [
...
class Augmentor(object):
    ...
    def __init__(self, n, m, augment_type):
        assert n >= 1
        assert 1 <= m <= 10
        self.n = n
        self.m = m
